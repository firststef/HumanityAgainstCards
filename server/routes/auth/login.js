    ...
    app.post("/auth/login",
             async (req, res) => {
                 try {
                     ...
                     if ( await user.check_login_info(req.body.username,
                                                      password) === false ) throw `You got the username or password wrong !`;
                     ...
                     if ( false === await user.session_update_login(req.body.username,
                                                                    password,
                                                                    cookie_session) ) throw "Error at updateing the session !";
