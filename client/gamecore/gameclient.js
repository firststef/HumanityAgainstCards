    ...
    update(data){//this will return maybe a response with accepted/invalid
        ...
        if (this.state === basedata.GameStates.CHOOSE_WHITE_CARD){
            ...
            if (this.type === basedata.PlayerTypes.PLAYER) {
                ...
                if(this.selectedWhiteCardSets[0][0]=== null){
    ...
    putData (data){
        ...
        if (this.state === basedata.GameStates.CHOOSE_WHITE_CARD
            ...
            if (data.wait_end === true) {
                console.log('White card choice timed out -- PLAYER');
                this.state = basedata.GameStates.CHOSEN_WHITE_CARD;
                this.choice = [];

                return {
                    header: 'player_choice_time_out',
                }
            }

            return {
                header: 'playernot_yet_timed_out',
        ...
        if (this.state === basedata.GameStates.CHOOSE_WHITE_CARD
            ...
            if (data.wait_end === true) {
                console.log('White card choice timed out -- CZAR');
                this.state = basedata.GameStates.CHOSEN_WHITE_CARD;
                this.choice = [];
                return {
                    header: 'czar_choice_time_out',
                }
            }

            return {
                header: 'czarnot_yet_timed_out'
            }
        }
